...
const LockIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M8 7V5.5A2.5 2.5 0 0 1 13 5.5V7"
      stroke="var(--theme-foreground)"
      strokeWidth="1.2"
    />
...
export function CourseDetail({
  ...
  return (
    <Section>
      ...
      >
        <h2
          style={{ margin: 0, color: "var(--theme-primary)", flex: "1 1 auto" }}
        >
          {course.name}
        </h2>
      ...
      >
        <strong style={{ color: "var(--theme-primary)" }}>Schedule:</strong>{" "}
        {course.schedule} <br />
        <strong style={{ color: "var(--theme-primary)" }}>Price:</strong>{" "}
        {course.price > 0 ? `$${course.price.toLocaleString()} USD` : "TBD"}
      ...
      <h3 style={{ color: "var(--theme-primary)", marginBottom: "1em" }}>
